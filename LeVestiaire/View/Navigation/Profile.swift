...
struct Profile: View {
    ...
    private var sportCard: some View {
        UCard(title: L10n.sportProfileTitle, icon: "sportscourt.fill") {
            VStack(alignment: .leading, spacing: 12) {
                profileRow(
    ...
    private var statsCard: some View {
        UCard(title: L10n.statistics, icon: "chart.bar.fill") {
